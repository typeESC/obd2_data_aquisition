...
#define WIFI_SSID           "YOUR_WIFI_SSID"        // Configure your WiFi SSID
#define WIFI_PASSWORD       "YOUR_WIFI_PASSWORD"    // Configure your WiFi password
#define WIFI_MAX_RETRY      5                       // Maximum WiFi connection retries
#define WIFI_RETRY_DELAY    5000                    // Delay between retries (ms)

// === API CONFIGURATION ===
#define API_BASE_URL        "http://192.168.1.100:8000/api/v1"  // Configure your API server IP
...
#define PERF_END(name)          ESP_LOGD(LOG_TAG, "%s took %lld us", name, esp_timer_get_time() - _perf_start)
#else
